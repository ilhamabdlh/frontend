...
var dayValueArr = [0, 0.4, 1.1, 1.8, 2.4, 2.9, 3.4, 4.1, 4.9, 5.4, 5.9, 6.5, 7.1, 7.9, 8.6, 8.9, 9.6, 9.9, 10.6, 11.4, 12.1, 12.9, 13.6, 14.1];
...
var chartConfigs9 = {
    ...
    width: "100%",
    height: "300",
    dataSource: nine_chart_month
};

export default chartConfigs9;
export { nine_chart_today };
export { nine_chart_month };
export { nine_chart_year };