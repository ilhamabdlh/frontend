...
var dayValueArr = [2.8, 3.3, 3.9, 3.1, 2.6, 3.1, 3.8, 4.3, 4.8, 4.2, 3.9, 3.1, 2.5, 3.4, 4.1, 4.9, 5.4, 6.0, 6.9, 7.5, 8.2, 8.9, 9.6, 10.2];
...
var chartConfigs8 = {
    ...
    width: "100%",
    height: "300",
    dataSource: eight_chart_month
};

export default chartConfigs8;
export { eight_chart_today };
export { eight_chart_month };
export { eight_chart_year };