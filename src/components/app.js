                ...
                <div className="container-fluid">
                    <div className="row flex-xl-nowrap">
                        ...
                        <div id="nav" className="col-12 col-md-3 col-xl-2 bd-sidebar">
                            <div className="row">
                                <div className="col-md-12 col-8">
                                    <div className="text-sm-left text-md-center logo" > <img src={atop} className="logo"></img></div>
                                </div>
                        ...
                        <div id="content-body" className="col-12 col-md-9 col-xl-10 pl-4 pr-4 bd-content">
                            {/* <!-- heading row --> */}
                            <div className="row">
                                <div className="col-md-12 pt-4 mt-3"><h2>Energy Dashboard</h2>
                                <div><img className="user" src={user}></img><br></br><div className="username"><h8>Name User</h8></div> </div>
                    ...
                    <!-- chart row start -->  */}
                            <div className="row mt-3 db-chart">
                                ...
                                <div id="parent2" className="col-lg-6 col-xl-4">
                                    <div className="chart-card mb-4">
                                        <div className="chart-title" id="text2">WBP & LWBP COST</div>
                                        <div id="chart2" className="chart">Chart 2</div>
                                    </div>
                                </div>
                                <div id="parent10" className="col-lg-6 col-xl-4">
                                    <div className="chart-card mb-4">
                                        <div className="chart-title" id="text2">KwH Meter</div>
                                        <div id="chart10" className="chart">Chart 10</div>
                                    </div>
                                </div>
                                <div id="parent3" className="col-lg-6 col-xl-4">
                                    <div className="chart-card mb-4">
                                        <div className="chart-title" id="text3">KwH Consumption</div>
                                        <div id="chart3" className="chart">Chart 3</div>
                                    </div>
                                </div>
                                <div id="parent8" className="col-lg-6 col-xl-4">
                                    <div className="chart-card mb-4">
                                        <div className="chart-title" id="text3">LWBP Consumption</div>
                                        <div id="chart8" className="chart">Chart 3</div>
                                    </div>
                                </div>
                                <div id="parent9" className="col-lg-6 col-xl-4">
                                    <div className="chart-card mb-4">
                                        <div className="chart-title" id="text3">WBP Consumption</div>
                                        <div id="chart9" className="chart">Chart 3</div>
                                    </div>
                                </div>
                                <div id="parent4" className="col-lg-12 col-xl-12">
                                    <div className="chart-card mb-4">
                                        <div className="chart-title" id="text4">Parameter Energy</div>
                                ...
                                {/* <div id="parent6" className="col-lg-6 col-xl-4">
                                    <div className="chart-card mb-4">
                                        <div className="chart-title" id="text6">OTHER</div>
